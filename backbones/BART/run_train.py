...
def train():
    ...
    wandb.init(project='English_Conversational_Planning', name = f"Baseline_Conversational_Gen_BART_{args.use_tcp}_{args.random_seed}")
    wandb.watch(model)
    ...
    def log_iterations(engine):
        ...
        if engine.state.iteration % args.valid_steps == 0:
            ...
            wandb.log({'val/average_ppl': metrics['average_ppl']})
